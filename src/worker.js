...
workQueue.process(async (job) => {
  //create a new job
  const { text, numQuestions, userId, assessmentName, topicId, difficulty } = job.data;
  result = await processAssessment(text, numQuestions, userId, assessmentName,topicId, difficulty);
